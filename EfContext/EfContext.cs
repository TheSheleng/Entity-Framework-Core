    ...
    public class EfContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Manager>()          // Налаштування навігаційних властивостей
                    .HasOne(m => m.MainDepartment)      // один-до... - зазнаачємо саме навігаційну
                    .WithMany(d => d.MainManagers)       // ...багатьох - також навігаційна колекція
                    .HasForeignKey(m => m.IdMainDep)    // зовнішній ключ - у Manager
                    .HasPrincipalKey(d => d.Id);        // первинний ключ - у Department

            modelBuilder.Entity<Manager>()          // Правила за замовч.
                .HasOne(m => m.SecondaryDepartment) // Id
                .WithMany(d => d.SecondaryManagers)  // [Table]Id
            ...
            modelBuilder.Entity<Sale>()  // Оскільки в Sale поле ManagerId
